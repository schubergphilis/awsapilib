...
# -*- coding: utf-8 -*-
#
# awsapilib documentation build configuration file, created by
# sphinx-quickstart
#
...
sphinx.ext.apidoc.main(argv=['-f', '-o', os.path.join(project_root, 'docs'),
                             os.path.join(project_root, '''awsapilib''')])
...
version = awsapilib.__version__
# The full version, including alpha/beta/rc tags.
release = awsapilib.__version__
...
htmlhelp_basename = '''awsapilibdoc'''
